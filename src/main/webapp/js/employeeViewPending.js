...
window.onload = function() {
    ...
    if (email != "") {
    	...
    	xhr.open("POST", "http://localhost:8080/Project_1/employeeViewPending.msp1", true);
    	xhr.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
    	console.log("sending http request with email" + email);
    	xhr.send("email=" + email);
    } else {
    	if (document.location.href != "http://localhost:8080/Project_1/html/EmployeeLogin.html" &&
